...
class Enqueue{
	...
	function enqueue(){
		...
		wp_enqueue_script('my_customs_scripts', PLUGIN_URL . '/assets/admin.js' );
	}

	function enqueue_frontend(){
		//enqueue all our scripts frontend

		wp_enqueue_script('my_frontend_scripts', PLUGIN_URL . 'assets/frontend.js' ,array ('jquery'), '1.0', true );
	}
}